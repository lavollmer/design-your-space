...
export const furnitureByRoom = {
    "Living Room": [
        ...
        { id: 'chair', name: 'Chair', img: '/assets/chair_livingroom.png' },
        { id: 'hanging chair', name: 'Hanging Chair', img: '/assets/hanging_chair.png' },
        { id: 'rug', name: 'Rug', img: '/assets/rug.png' }
    ],
    "Bedroom": [
    ...
    "Office": [
        ...
        {id:'rug', name: 'Rug', img: '/assets/rug.png'},
        {id: 'hanging plant', name: 'Hanging Plant', img: '/assets/hanging_plant.png'}
    ],
}